...
maxcov <- 202 # upper coverage threshold for autosomes
mincov <- 51 # lower coverage threshold for autosomes
maxcov_sex <- 150 # upper coverage threshold for the sex chromosome
mincov_sex <- 37 # lower coverage threshold for the sex chromosome
...
#### OLD VERSION BELOW. It's written using dplyr which makes it much slower. 
# # modify the data
